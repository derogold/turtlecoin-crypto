...
static void fe_mul(fe h, const fe f, const fe g)
{
    ...
    int64_t h2 =
        f0g2 + f1g1_2 + f2g0 + f3g9_38 + f4g8_19 + f5g7_38 + f6g6_19 +
        f7g5_38 + f8g4_19 + f9g3_38;
    int64_t h3 =
        f0g3 + f1g2 + f2g1 + f3g0 + f4g9_19 + f5g8_19 + f6g7_19 + f7g6_19 +
        f8g5_19 + f9g4_19;
    int64_t h4 =
        f0g4 + f1g3_2 + f2g2 + f3g1_2 + f4g0 + f5g9_38 + f6g8_19 +
        f7g7_38 + f8g6_19 + f9g5_38;
    int64_t h5 =
        f0g5 + f1g4 + f2g3 + f3g2 + f4g1 + f5g0 + f6g9_19 + f7g8_19 +
        f8g7_19 + f9g6_19;
    int64_t h6 =
        f0g6 + f1g5_2 + f2g4 + f3g3_2 + f4g2 + f5g1_2 + f6g0 + f7g9_38 +
        f8g8_19 + f9g7_38;
    int64_t h7 =
        f0g7 + f1g6 + f2g5 + f3g4 + f4g3 + f5g2 + f6g1 + f7g0 + f8g9_19 +
        f9g8_19;
    int64_t h8 =
        f0g8 + f1g7_2 + f2g6 + f3g5_2 + f4g4 + f5g3_2 + f6g2 + f7g1_2 +
        f8g0 + f9g9_38;
    int64_t h9 =
...
void
ge_double_scalarmult_base_vartime(ge_p2 * r, const unsigned char *a,
...
static void
ge_precomp_cmov(ge_precomp * t, const ge_precomp * u, unsigned char b)
{
...
static void
ge_cached_cmov(ge_cached * t, const ge_cached * u, unsigned char b)
{
    fe_cmov(t->YplusX, u->YplusX, b);
    fe_cmov(t->YminusX, u->YminusX, b);
    fe_cmov(t->Z, u->Z, b);
...
/* Assumes that a[31] <= 127 */
void ge_scalarmult_p3(ge_p3 * rr, const unsigned char *a, const ge_p3 * A)
{
    signed char e[64];
...
void
ge_double_scalarmult_precomp_vartime(ge_p2 * r, const unsigned char *a,
                                     const ge_p3 * A,
                                     const unsigned char *b,
                                     const ge_dsmp Bi)
{
...
void ge_double_scalarmult_precomp_vartime_p3(ge_p3 * r,
                                             const unsigned char *a,
                                             const ge_p3 * A,
                                             const unsigned char *b,
                                             const ge_dsmp Bi)
{
    ...
    ge_dsm_precomp(Ai, A);
    ge_double_scalarmult_precomp_vartime2_p3(r, a, Ai, b, Bi);
}
...
void ge_mul8_p2(ge_p1p1 * r, const ge_p2 * t)
{
    ge_p2 u;
...
void ge_mul8(ge_p1p1 * r, const ge_p3 * t)
{
    ge_p2 u;
...
void
sc_mulsub(unsigned char *s, const unsigned char *a, const unsigned char *b,
          const unsigned char *c)
{
    ...
    s10 =
        c10 - (a0 * b10 + a1 * b9 + a2 * b8 + a3 * b7 + a4 * b6 + a5 * b5 +
               a6 * b4 + a7 * b3 + a8 * b2 + a9 * b1 + a10 * b0);
    s11 =
        c11 - (a0 * b11 + a1 * b10 + a2 * b9 + a3 * b8 + a4 * b7 +
               a5 * b6 + a6 * b5 + a7 * b4 + a8 * b3 + a9 * b2 + a10 * b1 +
               a11 * b0);
    s12 =
        -(a1 * b11 + a2 * b10 + a3 * b9 + a4 * b8 + a5 * b7 + a6 * b6 +
          a7 * b5 + a8 * b4 + a9 * b3 + a10 * b2 + a11 * b1);
    s13 =
        -(a2 * b11 + a3 * b10 + a4 * b9 + a5 * b8 + a6 * b7 + a7 * b6 +
          a8 * b5 + a9 * b4 + a10 * b3 + a11 * b2);
    s14 =
        -(a3 * b11 + a4 * b10 + a5 * b9 + a6 * b8 + a7 * b7 + a8 * b6 +
          a9 * b5 + a10 * b4 + a11 * b3);
    s15 =
        -(a4 * b11 + a5 * b10 + a6 * b9 + a7 * b8 + a8 * b7 + a9 * b6 +
          a10 * b5 + a11 * b4);
    s16 =
        -(a5 * b11 + a6 * b10 + a7 * b9 + a8 * b8 + a9 * b7 + a10 * b6 +
          a11 * b5);
...
void sc_mul(unsigned char *s, const unsigned char *a,
            const unsigned char *b)
{
    int64_t a0 = 2097151 & load_3(a);
...
int sc_isvalid_vartime(const unsigned char *s)
{
    int64_t s0 = load_4(s);
    ...
    return (int) ((signum(1559614444 - s0) +
                   ...
                   (signum(350157278 - s3) << 3) + (signum(-s4) << 4) +
                   (signum(-s5) << 5) + (signum(-s6) << 6) +
                   (signum(268435456 - s7) << 7)) >> 8) == 0;
}
